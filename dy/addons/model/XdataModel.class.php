<?php
// +----------------------------------------------------------------------
// | QimingDao [ open your team ! ]
// +----------------------------------------------------------------------
// | Copyright (c) 2010 http://www.qimingcx.com.cn All rights reserved.
// +----------------------------------------------------------------------
// | Author: qimingcx.com <企明创想>
// +----------------------------------------------------------------------
// $Id$
...
class XdataModel extends Model {
	...
	public function get($key) {
		...
		$data = isset($keys[1])?$list[$keys[1]]:$list[''];
		return $data;
	}
	/**
	 *  传入的key参数为直接要获取的的key值
	 *  
	 * @param  $key 在配置中的key值 [必须]
	 * @param  $systemKey 在system_data表中的key值 [必须]
	 * @param  $systemList 在system_data表中的list值 默认为Config
	 */
